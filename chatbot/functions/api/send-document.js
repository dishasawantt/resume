        ...
        const html = `
            <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto">
                ...
                <div style="margin:30px 0">
                    <a href="https://dishasawantt.github.io/resume/Resume%20-%20Disha%20Sawant%202026.pdf" style="display:inline-block;padding:12px 24px;background:linear-gradient(135deg,#d48466,#f7ce68);color:white;text-decoration:none;border-radius:8px;font-weight:600">📄 Download Resume</a>
                </div>
                <div style="margin:30px 0">
